...
@Entity(name="MypagePromemAndLicense")
@Table(name="TBL_PROMEMBER")
public class MypagePromemAndLicense {
	@Id
	...
	public MypagePromemAndLicense() {
		super();
	}

	public MypagePromemAndLicense(int promemNo, String promemId, String promemName, String promemGender,
			String promemPhone, String promemEmail, String promemAddress, String promemNickname, Integer totalComment,
			Integer totalLikeNo, String businessRegNum, String businessRegFileName, String businessRegFileRename,
	...
	public String toString() {
		return "MypagePromemAndLicense [promemNo=" + promemNo + ", promemId=" + promemId + ", promemName=" + promemName
				...
				+ ", companyAddress=" + companyAddress + ", authorityRequest=" + authorityRequest + ", license="
				+ license + "]";
	}
