...
@Entity(name="MypagePromemAndProfile")
@Table(name="TBL_PROMEMBER")
public class MypagePromemAndProfile {
	@Id
	...
	public MypagePromemAndProfile() {
		super();
	}

	public MypagePromemAndProfile(int promemNo, String promemId, String promemName, String promemGender,
	...
	public String toString() {
		return "MypagePromemAndProfile [promemNo=" + promemNo + ", promemId=" + promemId + ", promemName=" + promemName
				...
				+ ", companyAddress=" + companyAddress + ", authorityRequest=" + authorityRequest + ", profile="
				+ profile + "]";
	}
