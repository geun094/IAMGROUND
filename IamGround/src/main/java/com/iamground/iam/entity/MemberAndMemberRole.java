...
public class MemberAndMemberRole {
	@Id
	@GeneratedValue(
	...
	public MemberAndMemberRole() {
		super();
	}

	public MemberAndMemberRole(int memNo, String memName, String memGender, String memPhone, String memEmail,
